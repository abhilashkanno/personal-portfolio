const experiences = [
  ...
  },
  {
    ...
    description:
      "Designed and developed responsive web interfaces for insurance product configuration and policy management systems using HTML5, CSS3, JavaScript, and ReactJS. Integrated frontend applications with RESTful APIs and Node.js services, building data-driven UI components for policy and claims workflows. Produced wireframes and UX documentation to support stakeholder reviews and design iterations, translating business requirements into structured frontend specifications.",
  ...
  },
  {
    ...
    company: "AccelQ",
    description:
      "Contributed to a cloud-based codeless test automation platform, building frontend interfaces and interactive configuration UX using JavaScript and HTML5 for non-technical users. Designed and implemented a results dashboard UI using ReactJS and CSS3 that visualized test execution status and pass/fail trends in real time. Built reusable UI components and drag-and-drop workflow builders and configured npm-based build toolchains with GitHub Actions for frontend CI pipelines.",
